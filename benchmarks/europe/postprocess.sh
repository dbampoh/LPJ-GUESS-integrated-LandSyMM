...
describe_image maxLAIeurope.jpg "Species With the Highest LAI in Each Gridcell (1961-90 average)" embed
...
describe_image maxCMASSeurope.jpg "Species With the Highest CMASS in Each Gridcell (1961-90 average)" embed
