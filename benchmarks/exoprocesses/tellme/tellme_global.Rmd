...
output: 
 html_document:
  toc: true
params:
  config_file: "/home/mforrest/Tools/DGVMBenchmarks/inst/tellme_global_config.yml"
...
all_settings <- parseConfigFile(config_file)
...
## Models runs
```{r print sources, echo = TRUE}
print(simulation_sources)
```

## Settings
```{r print settings, echo = TRUE}
print(settings)
```

## Benchmarks
```{r print benchmarks, echo = TRUE}
print(benchmarks)
```
...
if(do_Global_Summary_Tables) {
  this_complete_df <- modelSummaryTable(simulations = simulation_sources, 
                                        ...
                                        new_sim =  settings$new_name, 
                                        old_sim = settings$old_name, 
