...
bool iflandsymm_nfert_after_phenology;
bool iflandsymm_lc_before_management;
...
bool iflandsymm_hydrology_routing;
...
void initsettings() {
	...
	iflandsymm_nfert_after_phenology = false;
	iflandsymm_lc_before_management = false;
	...
	iflandsymm_hydrology_routing = false;
...
void plib_declarations(int id,xtring setname) {
	...
	case BLOCK_GLOBAL:
		...
		declareitem("iflandsymm_nfert_after_phenology", &iflandsymm_nfert_after_phenology, 1, CB_NONE, "Whether to run nfert after crop sowing/phenology instead of before (0=LTS nfert-first default)");
		declareitem("iflandsymm_lc_before_management", &iflandsymm_lc_before_management, 1, CB_NONE, "Whether to run landcover_dynamics before getmanagement in yearly sequence (0=LTS management-first default)");
		...
		declareitem("iflandsymm_hydrology_routing", &iflandsymm_hydrology_routing, 1, CB_NONE, "Whether to use fork hydrology routing in hydrology_lpjf: infiltrate_upland() for non-saturating stands + get_soil_water_status() after infiltration (1=fork) or LTS inline proportional infiltration (0=default)");
