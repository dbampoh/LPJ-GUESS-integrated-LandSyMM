...
//                                 University of Lund                                //
//                                                                                   //
//  Documentation: see header file gutil.h                                           //
//                                                                                   //
//  This version dated 13 August 2001                                                //
//  All rights reserved, copyright retained by the author .                          //
//  Address enquiries to: Dr B Smith, Climate Impacts Group, Plant Ecology Dept,     //
//                        University of Lund, Ekologihuset, Solvegatan 37,           //
//                        22362 Lund, Sweden                                         //
//                        Fax: +46 46 222 4423                                       //
...
long xtring::findnotoneof(char* s) {
...
xtring xtring::operator+(char* s2) {
...
char xtring::operator==(xtring& s2) {

	if (strcmp(ptext,s2.ptext)) return 0;
	return 1;
}

char xtring::operator==(char* s2) {

	if (strcmp(ptext,s2)) return 0;
	return 1;
}

char xtring::operator==(const char* s2) {

	if (strcmp(ptext,s2)) return 0;
	return 1;
}

char xtring::operator==(char c) {

	if (strcmp(ptext,(xtring)c)) return 0;
	return 1;
}

char xtring::operator!=(xtring& s2) {

	if (strcmp(ptext,s2.ptext)) return 1;
	return 0;
}

char xtring::operator!=(char* s2) {

	if (strcmp(ptext,s2)) return 1;
	return 0;
}
...
char xtring::operator!=(char c) {
	...
	if (strcmp(ptext,(xtring)c)) return 1;
	return 0;
}

char xtring::operator<(xtring& s2) {

	if (strcmp(ptext,s2.ptext)<0) return 1;
	return 0;
}

char xtring::operator<(char* s2) {

	if (strcmp(ptext,s2)<0) return 1;
	return 0;
}
...
char xtring::operator<(char c) {
	...
	if (strcmp(ptext,(xtring)c)<0) return 1;
	return 0;
}
...
//////////////////////////////////////////////////////////////////////////////////////
// READFOR
// Reads in ASCII text data from a stream, according to a FORTRAN-style format
// specification.
// Documentation: see header file gutil.h
