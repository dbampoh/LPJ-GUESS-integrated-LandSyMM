...
private:
	...
	// Output file names ...
	xtring file_cmass,file_anpp,file_dens,file_lai,file_cflux,file_cpool,file_clitter,file_runoff;
	...
	// Output tables
	Table out_cmass, out_anpp, out_dens, out_lai, out_cflux, out_cpool, out_clitter, out_firert, out_runoff, out_speciesheights;
