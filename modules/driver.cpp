...
void soilparameters(Soiltype& soiltype, int soilcode) {
	...
	double data[9][9] = {
		...
		{   4.0, 0.150,   0.2, 0.650,   0.4,	0.184,	0.439,	0.40,	0.20},    // 2	Medium
		{   3.0, 0.120,   0.2, 0.500,   0.4,	0.274,	0.454,	0.20,	0.60},    // 3	Fine
		{   4.5, 0.130,   0.2, 0.725,   0.4,	0.129,	0.417,	0.60,	0.15},    // 4	Medium-coarse
		{   4.0, 0.115,   0.2, 0.650,   0.4,	0.174,	0.425,	0.60,	0.30},    // 5	Fine-coarse
		{   3.5, 0.135,   0.2, 0.575,   0.4,	0.229,	0.447,	0.10,	0.45},    // 6	Fine-medium
		{   4.0, 0.127,   0.2, 0.650,   0.4,	0.177,	0.430,	0.30,	0.35},    // 7	Fine-medium-coarse
