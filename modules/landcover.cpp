...
*/
					...
					acflux_harvest_cp=patch.fluxes.acflux_harvest;	//flux �r nollst�lld
...
*/						harvest_natural(cmass_leaf_cp,cmass_root_cp,cmass_sap_cp,cmass_heart_cp,cmass_debt_cp,	//kolla vad som h�nder h�r, b�de f�r tr�d och gr�s !
